...
SAMPLES = [
    Sample("logo-badge", "logo-badge-premium-v4", "Logo badge relief", "logo", 95, 2.4, 128, "transparent logo PNG", "matte graphite PLA"),
    Sample("universal-relief", "universal-relief-premium-v4", "Universal image relief", "relief", 110, 2.4, 128, "high contrast line-art input", "matte slate PLA"),
    Sample("lithophane-panel", "lithophane-panel-premium-v4", "Backlit lithophane panel", "lithophane", 100, 3.2, 128, "grayscale portrait photo", "warm white translucent PLA"),
    Sample("heightmap-surface", "heightmap-surface-premium-v4", "Heightmap surface", "heightmap", 120, 6.0, 128, "grayscale heightmap", "matte terrain resin"),
]
