...
export const tools: ToolConfig[] = [
  ...
  {
    slug: "ai-image-to-3d",
    navLabel: "AI Image to 3D",
    eyebrow: "AI 3D roadmap entry",
    title: "AI Image to 3D Model",
    description: "Plan an AI image-to-3D workflow while using the current relief, lithophane, logo, and heightmap tools for printable STL output today.",
    promise: "This page separates what is live now from the upcoming AI single-image and multi-image 3D generation path.",
    primaryCta: "Check Image Fit",
    secondaryCta: "View Current STL Tools",
    uploadLabel: "Upload an image to check the current best path",
    supported: "PNG, JPG, JPEG, WebP, GIF, BMP",
    controls: [
      { label: "Live today", value: "Relief STL", helper: "Generate printable 2.5D STL outputs now." },
      { label: "Planned", value: "GLB + STL", helper: "AI full-3D export needs a dedicated model pipeline." },
      { label: "Best input", value: "Multiple angles", helper: "True AI 3D works better with more than one view." },
    ],
    steps: ["Upload an image for fit checking.", "Use the current relief or lithophane path if it fits.", "Use the AI 3D roadmap when full model generation is available."],
    pains: ["Captures AI image-to-3D demand without making false output claims.", "Shows users the current printable alternatives.", "Creates a clean future home for GLB, STL, credits, and generation history."],
    outputFacts: [
      { label: "Current output", value: "Relief STL" },
      { label: "Future output", value: "AI GLB + STL" },
      { label: "Status", value: "Roadmap" },
    ],
    limit: "Current generation on this site is relief-style STL. Full AI 3D reconstruction, multi-image generation, and GLB export are planned as a separate Pro-quality pipeline.",
    related: [
      { label: "Image to STL", href: "/image-to-stl" },
    ...
    faq: [
      ...
      { q: "Why keep an AI page now?", a: "Users search for AI image to 3D, and this page explains the honest difference between current printable STL workflows and upcoming AI 3D generation." },
      { q: "Will future AI output include GLB?", a: "That is the planned direction: preview-friendly GLB plus STL export for 3D printing." },
    ],
  },
  {
    slug: "logo-to-stl",
