...
export const sampleWorkflows = [
  {
    ...
    metrics: "~18k-42k triangles depending on detail; STL geometry only",
  ...
  },
  {
    ...
    metrics: "Preview reports triangles, file size, and occupied coverage",
  ...
  },
  {
    ...
    metrics: "Typical thickness range: 0.8-3.2 mm before slicer settings",
  ...
  },
  {
    ...
    metrics: "Higher detail increases triangle count and STL size",
