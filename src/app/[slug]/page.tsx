  ...
  return (
    <>
      ...
      <section className="infoGrid">
        ...
        <article className="shell"><h2>Analytics and cookies</h2><p>PNGtoSTL uses lightweight analytics providers such as Google Analytics 4, Plausible, Ahrefs analytics, and Cloudflare Web Analytics to measure page views and product events such as sample clicks, feedback clicks, upload selected, generate clicked, generate success, download clicked, and generate error. These events help us understand reliability and improve the tool. They do not require image file contents, passwords, private keys, or generated STL file contents.</p></article>
        <article className="shell"><h2>Service providers</h2><p>PNGtoSTL runs on hosting and edge infrastructure providers that process technical request data needed to deliver pages, conversion responses, security controls, and logs. Analytics providers process usage events for product measurement. Cloudflare Email Routing forwards support messages sent to support@pngtostl.net. If we later add payment, authentication, storage, or API-key providers, this policy should be updated before those features are launched.</p></article>
